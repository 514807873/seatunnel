...
@Slf4j
public class HexadbCatalog extends AbstractJdbcCatalog {
    ...
    public HexadbCatalog(
            String catalogName,
            String username,
            String pwd,
            JdbcUrlUtil.UrlInfo urlInfo,
            String defaultSchema) {
        this(catalogName, username, pwd, urlInfo, defaultSchema, null);
    }
    ...
    protected void createTableInternal(TablePath tablePath, CatalogTable table, boolean createIndex)
        ...
        HexadbCreateTableSqlBuilder postgresCreateTableSqlBuilder =
                new HexadbCreateTableSqlBuilder(table, createIndex);
