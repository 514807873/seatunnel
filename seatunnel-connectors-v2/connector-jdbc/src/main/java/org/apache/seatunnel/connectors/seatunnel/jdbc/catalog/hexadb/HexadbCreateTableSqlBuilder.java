...
package org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.hexadb;
...
public class HexadbCreateTableSqlBuilder {
    ...
    public HexadbCreateTableSqlBuilder(CatalogTable catalogTable) {
        this(catalogTable, true);
    }

    public HexadbCreateTableSqlBuilder(CatalogTable catalogTable, boolean createIndex) {
    ...
    private String buildColumnSql(Column column) {
        ...
        // For simplicity, assume the column type in SeaTunnelDataType is the same as in HEXADB
        String columnType =
                StringUtils.equalsIgnoreCase(DatabaseIdentifier.HEXADB, sourceCatalogName)
