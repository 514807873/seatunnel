...
public class HexadbTypeConverter implements TypeConverter<BasicTypeDefine> {
    ...
    public static final HexadbTypeConverter INSTANCE = new HexadbTypeConverter();
