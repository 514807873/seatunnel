...
public enum FilterValueRuleEnum {
    ...
    static {
        ...
        RULE_MAP.put("in", (object, value) -> Arrays.asList(value.split(",")).contains(String.valueOf(object)));
        RULE_MAP.put("between", (object, value) -> {
    ...
    // 新的递归应用规则方法
    public static Boolean applyRules(RuleGroup ruleGroup, SeaTunnelRow row, Map<String, Integer> columnIndex) {
            ...
            if (result == null) {
                ...
                switch (logicalOperator) {
                    ...
                    case "OR":
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException("Unknown logical operator: " + logicalOperator);
                }
            }
        }
    ...
    // 应用单个规则
    private static Boolean applySingleRule(Rule rule, SeaTunnelRow row, Map<String, Integer> columnIndex) {
