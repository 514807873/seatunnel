...
//                "ErrorCode:[TRANSFORM_COMMON-02], ErrorDescription:[The input fields 'age' of
// 'FieldMapper' transform not found in upstream schema]",
...
//                                        .createTransform());
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-01], ErrorDescription:[The input field 'age1' of
// 'Copy' transform not found in upstream schema]",
//                exception.getMessage());
//
...
//                                        .createTransform());
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-01], ErrorDescription:[The input field 'ageB' of
// 'Copy' transform not found in upstream schema]",
...
//                                        .createTransform());
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-02], ErrorDescription:[The input fields 'age,gender'
// of 'Filter' transform not found in upstream schema]",
//                exception.getMessage());
//    }
//
//    @Test
...
//                                        .createTransform());
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-01], ErrorDescription:[The input field 'age' of
// 'JsonPath' transform not found in upstream schema]",
//                exception.getMessage());
//    }
//
//    @Test
...
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-01], ErrorDescription:[The input field 'age' of
// 'Replace' transform not found in upstream schema]",
//                exception.getMessage());
//    }
//
//    @Test
...
//        Assertions.assertEquals(
//                "ErrorCode:[TRANSFORM_COMMON-01], ErrorDescription:[The input field 'age' of
// 'Split' transform not found in upstream schema]",
//                exception.getMessage());
//    }
// }
